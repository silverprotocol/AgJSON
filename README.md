...
const agent = new LlmAgent({ name: "assistant", model: "gemini-3.8-flash", instruction: "Use the echo tool." });
...
Wire version `1.0.0-draft.6` — **Draft**, stable enough to build on, and we want your
